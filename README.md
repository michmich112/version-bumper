...
files: '["./file1.json", {"path":"./file2.txt"}, {"path":"./file3.yaml", "line":5}]'
...
rules: '[{"trigger":"commit","bump":"build"}, {"trigger": "commit", "branch": "master", "bump":"minor", "reset":"build"}, {"trigger":"commit","branch":"release","bump":"major", "reset":["minor","build"]}]'
```
